<div class="col-md-12 d-flex flex-column"  wire:poll style="height: 100vh;">
  {{-- Current time: {{ now() }} --}}
    ...
    <div class="d-flex align-items-center justify-content-between p-3 border-bottom">
      ...
      @else
      <img src="{{asset("storage/".$user->image)}}" class="rounded-circle me-3" width="40" alt="Lori Ferguson">
    ...
    <div class="flex-grow-1 overflow-auto p-3" style="background-color: #f5f5f5;">
      ...
      <div class="d-flex justify-content-start mb-3">
        ...
        <!-- Modal -->
        <div class="modal fade border-0" id="exampleModal1" aria-labelledby="exampleModalLabel" aria-hidden="true">
      ...
      <!-- Modal -->
      <div class="modal fade border-0" id="exampleModal" aria-labelledby="exampleModalLabel" aria-hidden="true">
          <div class="modal-dialog d-flex justify-content-center">
              <div class="modal-content p-0 border-0 w-50">
                  ...
                  <div class="modal-body  p-0">
                    <div class="card p-0 bg-dark border-0 ">
                      <img src="{{asset("storage/".$user->image)}}" class="card-img-top p-0" alt="Lori Ferguson"  >
                      <div class="card-body">
                        <div class="d-flex justify-content-around align-items-center">
                           {{-- <a href="/privatechating/{{$user->id}}"><i class="fas fa-comment-sms text-white"></i></a> --}}

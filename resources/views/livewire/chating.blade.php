 <div class="col-md-12 d-flex flex-column"wire:poll style="height: 100vh;">
        ...
        <div class="d-flex align-items-center justify-content-between p-3 border-bottom">
          <div class="d-flex align-items-center">
            ...
            <img src="{{asset("storage/".$room->image)}}" class="rounded-circle me-3" width="40" alt="Lori Ferguson">
            <div>
        ...
        <div class="flex-grow-1 overflow-auto p-3"  style="background-color: #f5f5f5;">
          ...
          <div class="d-flex justify-content-start mb-3">
           ...
           <button type="button" class="btn border-0" data-bs-toggle="modal" data-bs-target="#exampleModal{{$user->id}}">
            <div class="bg-secondary text-white rounded-circle d-flex justify-content-center align-items-center" style="width: 40px;height: 40px;"> <i class="fas fa-user"></i></div>
        </button>
      
       
        <!-- Modal -->
        <div class="modal fade border-0" id="exampleModal{{$user->id}}" aria-labelledby="exampleModalLabel" aria-hidden="true">
                ...
                <div class="modal-content p-0 border-0 w-50">
                    ...
                    <div class="modal-body  p-0">
                      <div class="card p-0 bg-dark border-0 " style="height: 300px;">
                        <div class="card-img-top p-0 position-relative bg-dark w-100 h-100">
                          <div class="bg-dark text-white top-0 position-absolute">{{$user->username}}</div>
                          <div class="bg-secondary text-white  d-flex justify-content-center align-items-center w-100 h-100" > <i class="fas fa-user fs-1"></i></div>
                        </div>
                       
                       
                        <div class="card-body">
                          <div class="d-flex justify-content-around align-items-center">
                             <a href="/privatechating/{{$user->id}}"><i class="fas fa-comment-sms text-white"></i></a>

                             <a ><i class="fas fa-phone  text-white"></i></a>
                             <a ><i class="fas fa-video  text-white"></i></a>
                             <a href=""> <i class="fas fa-info-circle  text-white"></i></a>
                            </div>
            ...
            @else
            <button type="button" class="btn border-0" data-bs-toggle="modal" data-bs-target="#exampleModal{{$user->id}}">
              <img src="{{asset("storage/".$user->image)}}" class="rounded-circle me-2" alt="Lori Ferguson"  style="width: 40px;height: 40px;">
          </button>
                      ...
                      <div class="modal-body  p-0">
                        ...
                        <div class="card p-0 bg-dark border-0 ">
                          <div class="card-img-top p-0 position-relative">
                            <div class="bg-dark text-white top-0 position-absolute">{{$user->username}}</div>
                             <img src="{{asset("storage/".$user->image)}}" class="w-100 h-100" alt="Lori Ferguson"  >
                          </div>
